...
![Flow chart describing the stages and intermediate steps of a YaMS alignment](Resources/Flow_chart.png)
...
![The basic Needleman-Wunsch algorithm: g = gap penalty, s(x,y) = score of aligning nucleic acids x and y.  $^{[4]}$](Resources/nw_level1.png)
...
![Needleman-Wunsch algorithm with affine gaps.  $^{[6]}$](Resources/nw_level2.png)
...
![Profile-Profile Needleman-Wunsch algorithm with affine gaps](Resources/nw_level3.png)
